...
ENTRYPOINT ["java", "-XX:+UseContainerSupport", "-Xms256m", "-Xmx256m", "-XX:+UseSerialGC", "-XX:MaxMetaspaceSize=256m", "-XX:ReservedCodeCacheSize=64m", "-Xss256k", "-XX:+ExitOnOutOfMemoryError", "-Djava.security.egd=file:/dev/./urandom", "-cp", ".:lib/*", "com.chatcrmlite.backend.ChatCrmBackendApplication"]
