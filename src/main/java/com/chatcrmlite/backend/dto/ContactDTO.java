...
public class ContactDTO implements Serializable {
    ...
    public ContactDTO(UUID id, String waId, String name, String email, String phone, List<String> tags, String source) {
        this.id = id;
        this.waId = waId;
        this.name = name;
        this.email = email;
    ...
    public static class ContactDTOBuilder {
        ...
        public ContactDTO build() {
            return new ContactDTO(id, waId, name, email, phone, tags, source);
        }
    }
}
