...
public class Contact extends BaseTenantEntity {
    ...
    public Contact(UUID id, String waId, String name, String email, List<Tag> tags, String source, User owner) {
        this.id = id;
        this.waId = waId;
        this.name = name;
        this.email = email;
    ...
    public static class ContactBuilder {
        ...
        public Contact build() {
            return new Contact(id, waId, name, email, tags, source, owner);
        }
    }
}
