...
public class Message extends BaseTenantEntity {
    ...
    public Message(UUID id, String waMessageId, List<Tag> tags, Contact contact, User owner, String content, Direction direction, LocalDateTime timestamp) {
        this.id = id;
    ...
    public static class MessageBuilder {
        ...
        public MessageBuilder tags(List<Tag> tags) { this.tags = tags; return this; }
