...
public class EmailNotificationListener {
    ...
    public void onLeadCreated(LeadCreatedEvent event) {
        ...
        // If contact has no email, try extracting from the first enquiry's message
        if (toEmail == null || toEmail.isBlank()) {
            ...
            if (toEmail != null) {
                ...
                // Update contact's email field for future use
        ...
        if (toEmail != null && !toEmail.isBlank()) {
            String enquiryMessage = firstEnquiryMessage(lead.getEnquiries());
        ...
        if (lead.getOwner() != null && lead.getOwner().getEmail() != null) {
            ...
            emailService.sendNewLeadToOwner(ownerEmail, ownerName, contactName, contactEmail,
                    firstEnquiryMessage(lead.getEnquiries()), event.getSource());
        }
    }
